<template>
	<dimple-uni-container>
		<view slot="header" style="background: #FFFFFF;">
			header
		</view>
...
<script>
	import DimpleUniContainer from '../../components/dimple-uni-container.vue'
	...
	export default {
		...
		methods: {
			...
			async getData(options = {}) {
				const {
					page = 1, skip = 0, limit = this.limit
				} = options
